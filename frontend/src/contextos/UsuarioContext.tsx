  ...
  const cargarUsuario = async (id: string): Promise<DatosUsuario | null> => {
    ...
    const usuariosMock: { [key: string]: DatosUsuario } = {
      'user-2': {
        ...
        cargo: { valor: 'Coordinadora de Projectes', privacidad: 'publico' },
        departamento: { valor: 'Àrea Social', privacidad: 'publico' },
        provincia: { valor: 'Girona', privacidad: 'publico' },
        ciudad: { valor: 'Girona', privacidad: 'publico' },
        intereses: ['Gestió Social', 'Voluntariat', 'Educació'],
        habilidades: ['Gestió de projectes', 'Treball en equip', 'Comunicació'],
      ...
      'user-3': {
        ...
        cargo: { valor: 'Desenvolupador Senior', privacidad: 'publico' },
        departamento: { valor: 'Departament IT', privacidad: 'publico' },
        provincia: { valor: 'Tarragona', privacidad: 'publico' },
        ciudad: { valor: 'Tarragona', privacidad: 'publico' },
        intereses: ['Programació', 'Startups', 'Transformació Digital'],
      ...
      'user-4': {
        ...
        organizacion: { valor: 'Generalitat de Catalunya', privacidad: 'publico' },
        cargo: { valor: 'Tècnica Superior', privacidad: 'publico' },
        departamento: { valor: 'Departament de Territori', privacidad: 'publico' },
        provincia: { valor: 'Lleida', privacidad: 'publico' },
        ciudad: { valor: 'Lleida', privacidad: 'publico' },
        intereses: ['Polítiques Públiques', 'Desenvolupament Rural', 'Medi Ambient'],
        habilidades: ['Anàlisi de polítiques', 'Planificació estratègica', 'Gestió de projectes'],
        idiomas: ['Català', 'Castellà', 'Francès'],
        mostrarPublicaciones: 'publico',
        mostrarConexiones: 'conexiones',
        mostrarGrupos: 'publico'
      },
      'user-5': {
        ...
        cargo: { valor: 'Delegat Sindical', privacidad: 'publico' },
        departamento: { valor: 'Secció Sindical Administració Pública', privacidad: 'publico' },
        provincia: { valor: 'Barcelona', privacidad: 'publico' },
        ciudad: { valor: 'Barcelona', privacidad: 'publico' },
        intereses: ['Drets Laborals', 'Negociació', 'Justícia Social'],
        habilidades: ['Negociació col·lectiva', 'Mediació', 'Comunicació'],
        idiomas: ['Català', 'Castellà'],
        mostrarPublicaciones: 'publico',
        mostrarConexiones: 'conexiones',
        mostrarGrupos: 'publico'
      }
